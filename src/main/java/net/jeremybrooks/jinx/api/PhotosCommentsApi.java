...
public class PhotosCommentsApi {
   ...
   * @see <a href="https://www.flickr.com/services/api/flickr.photos.comments.addComment.html">flickr.photos.comments.addComment</a>
   */
   ...
   * @throws JinxException if required parameters are missing, or if there are any errors.
   * @see <a href="https://www.flickr.com/services/api/flickr.photos.comments.deleteComment.html">flickr.photos.comments.deleteComment</a>
   */
   ...
   * @throws JinxException if required parameters are missing, or if there are any errors.
   * @see <a href="https://www.flickr.com/services/api/flickr.photos.comments.editComment.html">flickr.photos.comments.editComment</a>
   */
