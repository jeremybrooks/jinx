...
/**
 * Provides access to the {@code flickr.favorites} API methods.
 *
...
public class FavoritesApi {
   ...
   * @see <a href="https://www.flickr.com/services/api/flickr.favorites.add.html">flickr.favorites.add</a>
   */
   ...
   * @param perPage     Optional. Number of photos to return per page. If this argument is &le;= 0, it defaults to 100. The maximum allowed value is 500.
   ...
   * @see <a href="https://www.flickr.com/services/api/flickr.favorites.getPublicList.html">flickr.favorites.getPublicList</a>
   */
   ...
   * @return object with the result of the requested operation.
   * @throws JinxException if required parameters are null or empty, or if there are any errors.
   * @see <a href="https://www.flickr.com/services/api/flickr.favorites.remove.html">flickr.favorites.remove</a>
   */
